...
private:
	...
	QuadTexturedModel* m_cokeSignFront; // a sign for coke
	QuadTexturedModel* m_cokeSignBack;
	CubeModel* m_Player; //our protagonist game character object
	PrismModel* m_Enemy; //our  antagonist game character object
